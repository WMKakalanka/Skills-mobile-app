...
public class Learner_profile_managementActivity extends AppCompatActivity {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (firstName.isEmpty() || lastName.isEmpty() || phone.isEmpty() || email.isEmpty()) {
                    Toast.makeText(Learner_profile_managementActivity.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Learner_profile_managementActivity.this, "Profile Updated!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
